    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <p className="text-sm text-muted-foreground">
          Showing <span className="font-medium text-foreground">{issues.length}</span> of{" "}
          <span className="font-medium text-foreground">{total}</span> issues
        </p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="border-b border-border bg-muted/50">
            <tr>
              ...
              <th className="px-4 py-3 text-right font-medium text-muted-foreground">SP</th>
            </tr>
          </thead>
              ...
              return (
                <tr key={issue.id} className="hover:bg-muted/30 transition-colors">
                  ...
                  <td className="px-4 py-3 max-w-xs">
                    <span className="line-clamp-2">{issue.fields.summary}</span>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <span
                      className={cn(
                        "text-xs font-medium",
                        PRIORITY_COLORS[issue.fields.priority?.name ?? ""] ?? "text-muted-foreground"
                      )}
                    >
